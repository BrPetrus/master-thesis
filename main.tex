...
\thesissetup{
    ...
    abstract    = {%
        This thesis addresses the automated semantic segmentation of Tunnelling Nanotubes (TNTs) in 3D \textit{Drosophila} wing microscopy images. The work tackled challenges posed by high spatial anisotropy and sparse reference annotations.

        The primary contribution is the development of AnisoUNet, an anisotropic U-Net-like architecture designed to effectively handle the highly anisotropic nature of the 3D data. The solution utilised a robust 4-fold cross-validation pipeline.

        The study demonstrates the feasibility of using U-Net-like architectures for segmenting these nanoscale structures under data limitations. The resulting segmentation capability offers a basis for automating the quantitative analysis of cell morphogenesis dynamics.
    },
    thanks      = {%
