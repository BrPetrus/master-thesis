...
steps --- the 0th and 17th step ---  to label. The
...
magenta colour. As can be seen in the image, sometimes it is rather difficult to
decide if the protrusion is a TNT or not, in the figure, two areas are
highlighted by a red circle, where it is not clear why the biologist did not
also label the TNTs. This illustartes a possible difficulty when assesing the
segmentation accuracy later on.  % todo: make this more natural
