...
The complete source code for the U-Net-like neural network model, which includes the necessary training, evaluation, and inference scripts, is attached as an accompanying digital appendix. This archive also features automation scripts to streamline data processing and model execution. To facilitate understanding and setup, the archive includes a comprehensive \texttt{README} file that details the environment configuration, explains the project structure, and provides step-by-step instructions for running the code. Finally, the archive also contains all image data, including the used data splits and the evaluation dataset.
