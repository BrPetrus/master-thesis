...
\begin{itemize}
    \item{MLflow is a tool for handling machine learning pipelines. It allows
        ...
        to keep track of the experiments}[CITE]}  % cite
    ...
    \item{ruff linter cite is an extremely fast Python linter which was
        ...
        even correct some basic lint errors. [CITE]} 
    ...
    \item{scikit-learn provides a great framework for building machine learning
        ...
        batching. [CITE]}  % TODO: https://scikit-learn.org/stable/index.html
    ...
    \item{Pytorch is a popular deep learning framework with a focus on
        ...
        develop the program [CITE]} %https://pytorch.org/projects/pytorch/ 
    \item{MONAI is another open-source framework for building neural networks on
        ...
        dataset, as it provides first-class support for 3D data. [CITE]} % cite https://github.com/Project-MONAI/MONAI 
...
a virtual environment are resolved by a tool called uv [CITE], developed by
