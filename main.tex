...
\thesissetup{
    ...
    abstract    = {%
        This thesis addresses the automated semantic segmentation of Tunnelling Nanotubes (TNTs) in 3D \textit{Drosophila} wing microscopy images. The work tackled challenges posed by high spatial anisotropy and extremely sparse annotations.
