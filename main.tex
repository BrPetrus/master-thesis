...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Predictions on the second quadrant. (a) The original image (contrast-enhanced) with binarised reference annotations in magenta. (b) The prediction of BasicUNet, (c) 3D version of CSAM variant, (d) shows the 2D version of CSAM. Green represents TP, red stands for FP and blue for FN.}
