...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{overpic}[width=\textwidth]{resources/qualitative/quad1eval/t017-composite-slice7.png}
            \put(8,85){\Large \textbf{(a)}}
        \end{overpic}
        \label{fig:quad2orig}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{overpic}[width=\textwidth]{resources/qualitative/quad1eval/t017-slice7-basicunet.png}
            \put(8,85){\Large \textbf{(a)}}
        \end{overpic}
        \label{fig:quad2basicunet}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{overpic}[width=\textwidth]{resources/qualitative/quad1eval/t017-slice7-csam3d.png}
            \put(8,85){\Large \textbf{(a)}}
        \end{overpic}
        \label{fig:quad2csam3d}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{overpic}[width=\textwidth]{resources/qualitative/quad1eval/t017-slice7-csam2d.png}
            \put(8,85){\Large \textbf{(a)}}
        \end{overpic}
        \label{fig:quad2csam2d}
    \end{subfigure}
